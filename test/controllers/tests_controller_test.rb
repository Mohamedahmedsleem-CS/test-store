...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference("Test.count") do
      post tests_url, params: { test: { description: @test.description, name: @test.name, price: @test.price } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { description: @test.description, name: @test.name, price: @test.price } }
